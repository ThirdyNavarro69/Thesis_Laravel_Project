...
<?php $__env->startSection('title', 'Create Services'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#createServiceForm').submit(function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route("owner.services.store")); ?>',
                    type: 'POST',
                    data: formData,
                    success: function(response) {
                        if (response.success) {
                            ...
                            Swal.fire({
                                ...
                                `);
                                window.location.href = '<?php echo e(route("owner.services.index")); ?>';
                            });
                        } else {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.owner.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/owner/create-services.blade.php ENDPATH**/ ?>
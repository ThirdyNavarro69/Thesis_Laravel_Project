...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We regret to inform you that your studio registration for <strong><?php echo e($studio->studio_name); ?></strong> has been <strong>rejected</strong> by our admin team.</p>
            ...
            <div class="studio-info">
                ...
                <div class="info-item">
                    <i>📅</i> <strong>Review Date:</strong> <?php echo e(now()->format('F d, Y')); ?>
            ...
            <div class="rejection-note">
                ...
                <p style="white-space: pre-wrap; background: white; padding: 15px; border-radius: 5px; border: 1px solid #dee2e6;">
                    <?php echo e($studio->rejection_note); ?>
            ...
            <div style="text-align: center;">
                <a href="<?php echo e(url('/owner/studio/create')); ?>" class="btn">Update Studio Registration</a>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\proj\resources\views/emails/studio-rejected.blade.php ENDPATH**/ ?>
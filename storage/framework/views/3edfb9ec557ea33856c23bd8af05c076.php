...
<?php $__env->startSection('title', 'Registered Studios'); ?>
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="mb-0 fw-medium"><?php echo e($studio->location->street); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-2 mb-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="list-group">
                                            <?php if($studio->category): ?>
                                            <li class="list-group-item">
                                                <div class="d-flex align-items-start">
                                                    <i class="ti ti-check text-success me-2 mt-1"></i>
                                                    <div>
                                                        <h5 class="mb-1 fw-semibold"><?php echo e($studio->category->category_name); ?></h5>
                                                        <p class="text-muted mb-0">
                                                            <?php echo e($studio->category->description ?: 'No description available'); ?>

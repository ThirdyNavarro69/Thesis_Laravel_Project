                                    ...
                                    <?php if($services->count() > 0): ?>
                                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr data-id="<?php echo e($service->id); ?>">
                                                <td><?php echo e($service->studio ? $service->studio->studio_name : 'N/A'); ?></td>
                                                <td><?php echo e($service->category ? $service->category->category_name : 'N/A'); ?></td>
                                                <td><?php echo e($truncatedList); ?></td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <button class="btn btn-sm btn-eye-service">
                                                            <i class="ti ti-eye fs-lg"></i>
                                                        </button>
                                                        <button class="btn btn-sm btn-edit-service" data-id="<?php echo e($service->id); ?>">
                                                            <i class="ti ti-edit fs-lg"></i>
                                                        </button>
                                                        <button class="btn btn-sm btn-delete-service" data-id="<?php echo e($service->id); ?>">
                                ...
                                <select class="form-select" name="studio_id" id="edit_studio_id" required>
                                    ...
                                    <?php
                                        $verifiedStudios = \App\Models\StudioOwner\StudiosModel::where('user_id', auth()->id())
                                            ...
                                            ->get(['id', 'studio_name']);
                                    ?>
                                    <?php $__currentLoopData = $verifiedStudios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-edit-service', function() {
                ...
                $.ajax({
                    url: `<?php echo e(url('owner/services')); ?>/${serviceId}/edit`,
                    type: 'GET',
            ...
            $('#updateServiceBtn').click(function() {
                ...
                $.ajax({
                    url: `<?php echo e(url('owner/services')); ?>/${serviceId}`,
                    type: 'PUT',
                    data: formData,
                    success: function(response) {
                        if (response.success) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.owner.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/owner/view-services.blade.php ENDPATH**/ ?>
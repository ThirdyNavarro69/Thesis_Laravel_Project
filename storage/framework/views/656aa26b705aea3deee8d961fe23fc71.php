...
<?php $__env->startSection('title', 'Invite Freelancers'); ?>
                        ...
                        <div data-table data-table-rows-per-page="5" class="card">
                            ...
                            <div class="table-responsive">
                                <table class="table table-custom table-centered table-select table-hover table-bordered w-100 mb-0">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $freelancers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $freelancer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <?php
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex">
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="javascript:void(0)" class="link-reset"><?php echo e($freelancer->full_name); ?></a>
                                                            </h5>
                                                            <p class="mb-0 fs-xxs">
                                                ...
                                                <td><?php echo e($freelancer->mobile_number ?? 'N/A'); ?></td>
                                                <td>
                                                    <div class="d-flex">
                                                        <div>
                                                            <h5 class="mb-1">
                                                            ...
                                                            <p class="mb-0 fs-xxs">
                                                                <?php if($freelancer->freelancerProfile && $freelancer->freelancerProfile->categories->isNotEmpty()): ?>
                                                                    <span class="text-muted">
                                                                        <?php echo e($freelancer->freelancerProfile->categories->first()->category_name); ?>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start gap-1">
                                                        <button type="button" class="btn view-freelancer-btn" data-freelancer-id="<?php echo e($freelancer->id); ?>">
                                                            <i class="ti ti-eye"></i>
                                                        </button>
                                                        <?php if($isInvited): ?>
                                                        ...
                                                        <?php else: ?>
                                                            <button type="button" class="w-100 btn btn-sm btn-primary invite-btn" data-freelancer-id="<?php echo e($freelancer->id); ?>"data-freelancer-name="<?php echo e($freelancer->full_name); ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#invitationForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route("owner.members.invite.store")); ?>',
                    type: 'POST',
                    data: $(this).serialize(),
                    headers: {
...
<?php echo $__env->make('layouts.owner.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/owner/invite-members.blade.php ENDPATH**/ ?>
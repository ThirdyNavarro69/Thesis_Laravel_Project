                            ...
                            <table class="table table-custom table-centered table-select table-hover table-bordered w-100 mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-soft-<?php echo e($category->status == 'active' ? 'success' : 'danger'); ?> fs-8 px-1 w-100">
                                                <?php echo e(strtoupper($category->status)); ?>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-1">
                                                <button class="btn btn-sm edit-category-btn" data-id="<?php echo e($category->id); ?>" data-name="<?php echo e($category->category_name); ?>" data-description="<?php echo e($category->description); ?>" data-status="<?php echo e($category->status); ?>" data-bs-toggle="modal" data-bs-target="#editCategoryModal">
                                                    <i class="ti ti-edit fs-lg"></i>
                                                </button>
                                                <button class="btn btn-sm delete-category" data-id="<?php echo e($category->id); ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editCategoryForm').on('submit', function(e) {
                ...
                // Make AJAX request
                $.ajax({
                    url: "<?php echo e(url('admin/categories')); ?>/" + categoryId,
                    type: 'POST',
                    data: formData,
                    headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/admin/view-categories.blade.php ENDPATH**/ ?>
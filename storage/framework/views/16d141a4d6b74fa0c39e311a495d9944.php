...
<?php $__env->startSection('title', 'Studio Registration'); ?>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="studioRegistrationForm" action="<?php echo e(route('owner.studio.store')); ?>" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter your owner name" name="owner_name" 
                                            value="<?php echo e($user->first_name . ' ' . $user->last_name); ?>" readonly required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="tel" class="form-control" placeholder="Enter your mobile number" name="owner_mobile_number" 
                                            value="<?php echo e($user->mobile_number); ?>" readonly required>
                                        <div class="invalid-feedback">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#municipalitySelect').on('change', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route("owner.studio.get-barangays", ["municipality" => "__MUNICIPALITY__"])); ?>'.replace('__MUNICIPALITY__', municipality),
                    type: 'GET',
                    headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.owner.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/owner/create-studio.blade.php ENDPATH**/ ?>
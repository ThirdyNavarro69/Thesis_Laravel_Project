...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/plugins/dropzone/dropzone.css')); ?>" type="text/css">

    
    <link rel="stylesheet" href="<?php echo e(asset('assets/plugins/filepond/filepond.min.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('assets/plugins/filepond/filepond-plugin-image-preview.min.css')); ?>">
...
<body>
    ...
    <script src="<?php echo e(asset('assets/plugins/filepond/filepond.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/plugins/filepond/filepond-plugin-image-preview.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/plugins/filepond/filepond-plugin-file-validate-size.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/plugins/filepond/filepond-plugin-image-exif-orientation.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/plugins/filepond/filepond-plugin-file-encode.min.js')); ?>"></script>

    
    <script src="<?php echo e(asset('assets/js/pages/form-fileupload.js')); ?>"></script>

    
    <?php echo $__env->yieldContent('scripts'); ?>
</body>
</html><?php /**PATH C:\xampp\htdocs\proj\resources\views/layouts/admin/app.blade.php ENDPATH**/ ?>
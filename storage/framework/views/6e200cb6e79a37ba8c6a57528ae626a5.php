...
<?php $__env->startSection('title', 'Add Studio Photographers'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#studioSelect').on('change', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('owner.studio.services', ['id' => '__ID__'])); ?>".replace('__ID__', studioId),
                    method: 'GET',
            ...
            $('form.needs-validation').on('submit', function(e) {
                ...
                // Send AJAX request
                $.ajax({
                    url: "<?php echo e(route('owner.studio-photographers.store')); ?>",
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                        ...
                        if (response.success) {
                            Swal.fire({
                                ...
                                didClose: () => {
                                    ...
                                    window.location.href = "<?php echo e(route('owner.studio-photographers.index')); ?>";
                                }
                            });
                        } else {
                            Swal.fire({
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.owner.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/owner/create-studio-photographers.blade.php ENDPATH**/ ?>
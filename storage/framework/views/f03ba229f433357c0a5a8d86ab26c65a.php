    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.create-gallery, .manage-gallery', function() {
                ...
                $.ajax({
                    url: `<?php echo e(url('owner/online-gallery')); ?>/${bookingId}/details`,
                    type: 'GET',
                    success: function(response) {
                        if (response.success) {
                            ...
                            // Update the success section in the AJAX call
            ...
            $('#uploadGalleryForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: `<?php echo e(url('owner/online-gallery')); ?>/${selectedBookingId}/upload`,
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $(document).on('click', '.delete-image', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `<?php echo e(url('owner/online-gallery')); ?>/${currentGalleryId}/image`,
                            type: 'DELETE',
                            data: {
            ...
            $('#deleteGalleryBtn').on('click', function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `<?php echo e(url('owner/online-gallery')); ?>/${currentGalleryId}`,
                            type: 'DELETE',
                            data: {
                                _token: '<?php echo e(csrf_token()); ?>'
                            },
            ...
            $('#updateGalleryForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: `<?php echo e(url('owner/online-gallery')); ?>/${galleryId}`,
                    type: 'PUT',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.owner.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/owner/view-online-gallery.blade.php ENDPATH**/ ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            function submitForm() {
                ...
                // Submit via AJAX
                $.ajax({
                    url: '<?php echo e(route("owner.studio-schedule.store")); ?>',
                    type: 'POST',
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            Swal.fire({
                                ...
                                window.location.href = '<?php echo e(route("owner.studio-schedule.index")); ?>';
                            });
                        } else {
                            Swal.fire({
                                icon: 'error',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.owner.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/owner/setup-studios-schedules.blade.php ENDPATH**/ ?>
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($booking->client->first_name ?? ''); ?> <?php echo e($booking->client->last_name ?? ''); ?></td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.create-gallery, .manage-gallery', function() {
                ...
                $.ajax({
                    url: `<?php echo e(url('freelancer/online-gallery')); ?>/${bookingId}/details`,
                    type: 'GET',
            ...
            $('#uploadGalleryForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: `<?php echo e(url('freelancer/online-gallery')); ?>/${selectedBookingId}/upload`,
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $(document).on('click', '.delete-image', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `<?php echo e(url('freelancer/online-gallery')); ?>/${currentGalleryId}/image`,
                            type: 'DELETE',
                            data: {
            ...
            $('#deleteGalleryBtn').on('click', function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `<?php echo e(url('freelancer/online-gallery')); ?>/${currentGalleryId}`,
                            type: 'DELETE',
                            data: {
                                _token: '<?php echo e(csrf_token()); ?>'
                            },
            ...
            $('#updateGalleryForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: `<?php echo e(url('freelancer/online-gallery')); ?>/${galleryId}`,
                    type: 'PUT',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.freelancer.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/freelancer/view-online-gallery.blade.php ENDPATH**/ ?>
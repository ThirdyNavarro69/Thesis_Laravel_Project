<?php $__env->startSection('title', 'My Booking History'); ?>
                            ...
                            <table class="table table-custom table-centered table-select table-hover table-bordered w-100 mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr data-booking-id="<?php echo e($booking->id); ?>" data-booking-status="<?php echo e($booking->status); ?>">
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <small class="text-muted d-block"><?php echo e($booking->start_time); ?></small>
                                            </td>
                                            <td>
                                                <?php
                                                    $statusBadge = [
                                                ...
                                                ?>
                                                <span class="badge <?php echo e($statusBadge); ?> fs-8 px-2 w-100 text-uppercase"><?php echo e(strtoupper($statusText)); ?></span>
                                            </td>
                                            <td>
                                                <?php
                                                    $paymentBadge = [
                                                ...
                                                ?>
                                                <span class="badge <?php echo e($paymentBadge); ?> fs-8 px-2 w-100 text-uppercase"><?php echo e(strtoupper(str_replace('_', ' ', $booking->payment_status))); ?></span>
                                                <?php
                                                ...
                                                ?>
                                                <small class="<?php echo e($paymentClass); ?> d-block mt-1 text-center">
                                                    ₱<?php echo e(strtoupper(number_format($finalAmount, 2))); ?>
                                                    ...
                                                    <?php if($booking->status === 'completed'): ?>
                                                        <?php if($booking->booking_type === 'studio'): ?>
                                                            <button class="btn btn-sm review-studio-btn" 
                                                                    ...
                                                                    data-booking-type="<?php echo e($booking->booking_type); ?>"
                                                                    title="Leave Studio Review">
                                                                <i class="ti ti-star fs-lg"></i>
                                                            </button>
                                                        <?php elseif($booking->booking_type === 'freelancer'): ?>
    ...
    <script>
        $(document).ready(function() {
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center mb-3">
                                <div class="avatar-lg me-4">
                                    <img src="${booking.studio_logo ? '<?php echo e(asset("storage/")); ?>/' + booking.studio_logo : '<?php echo e(asset("assets/images/sellers/7.png")); ?>'}" 
                ...
                const formHtml = `
                    <form id="freelancerReviewForm" class="needs-validation" novalidate>
                        <div class="mb-4">
                            <div class="d-flex align-items-center mb-3">
                                <div class="avatar-lg me-4">
                                    <img src="${booking.freelancer_logo ? '<?php echo e(asset("storage/")); ?>/' + booking.freelancer_logo : '<?php echo e(asset("assets/images/sellers/3.png")); ?>'}" 
            ...
            function loadStudioPresetReviews(rating) {
                $.ajax({
                    url: '<?php echo e(route("client.reviews.preset")); ?>',
                    type: 'POST',
                    data: { rating: rating, _token: '<?php echo e(csrf_token()); ?>' },
                    success: function(response) {
            ...
            function loadFreelancerPresetReviews(rating) {
                $.ajax({
                    url: '<?php echo e(route("client.freelancer-reviews.preset")); ?>',
                    type: 'POST',
                    data: { rating: rating, _token: '<?php echo e(csrf_token()); ?>' },
                    success: function(response) {
                        if (response.success && response.reviews.length > 0) {
            ...
            $(document).on('submit', '#freelancerReviewForm', function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route("client.freelancer-reviews.store")); ?>',
                    type: 'POST',
                    data: formData,
                    beforeSend: function() {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.client.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/client/view-booking-history.blade.php ENDPATH**/ ?>
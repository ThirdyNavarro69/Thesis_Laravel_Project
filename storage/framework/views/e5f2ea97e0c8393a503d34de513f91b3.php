                                ...
                                <div class="card h-100 mb-2 border-1 shadow-sm">
                                    <div class="card-body pb-2">
                                        <div class="d-flex align-items-start">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(asset('assets/images/sellers/7.png')); ?>" class="rounded" alt="Luxe Lens Co." style="width: 100px; height: 100px; object-fit: cover;">
                                            </div>                                            
                                    ...
                                    <div class="card-footer bg-transparent border-top">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <a class="btn btn-primary px-4" href="<?php echo e(route('client.booking-details')); ?>">Book Service</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="card h-100 mb-2 border-1 shadow-sm">
                                    <div class="card-body pb-2">
                                        <div class="d-flex align-items-start">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(asset('assets/images/sellers/3.png')); ?>" class="rounded" alt="Luxe Lens Co." style="width: 100px; height: 100px; object-fit: cover;">
                                            </div>                                            
                                            <div class="flex-grow-1 ms-3">

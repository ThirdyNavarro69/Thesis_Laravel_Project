                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <div class="avatar-lg me-1">
                                                        <img src="<?php echo e(asset('assets/images/products/1.png')); ?>" alt="Product" class="img-fluid rounded">
                                                    </div>
                                                    <div>
                                                        <h5 class="mb-1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <div class="avatar-lg me-1">
                                                        <img src="<?php echo e(asset('assets/images/products/2.png')); ?>" alt="Product" class="img-fluid rounded">
                                                    </div>
                                                    <div>
                                                        <h5 class="mb-1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <div class="avatar-lg me-1">
                                                        <img src="<?php echo e(asset('assets/images/products/3.png')); ?>" alt="Product" class="img-fluid rounded">
                                                    </div>
                                                    <div>
                                                        <h5 class="mb-1">
                            ...
                            <div class="col-md-4 col-lg-3">
                                <div class="text-center">
                                    <div class="position-relative d-inline-block mb-3">
                                        <img src="<?php echo e(asset('assets/images/users/user-1.jpg')); ?>" alt="avatar" 

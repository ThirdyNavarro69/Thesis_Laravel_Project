...
<?php $__env->startSection('title', 'Invited Freelancers'); ?>
                ...
                <div class="col-12">
                    ...
                    <?php if(!$studio): ?>
                        <div class="alert alert-warning">
                            ...
                            <a href="<?php echo e(route('owner.studio.create')); ?>" class="alert-link">Create Studio</a>
                        </div>
                    <?php else: ?>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <?php if($member->freelancer && $member->freelancer->profile && $member->freelancer->profile->brand_logo): ?>
                                                            <img src="/storage/<?php echo e($member->freelancer->profile->brand_logo); ?>" class="rounded-circle me-3" style="width: 40px; height: 40px; object-fit: cover;" alt="<?php echo e($member->freelancer->full_name); ?>">
                                                        <?php endif; ?>
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="javascript:void(0)" class="link-reset view-freelancer-btn" data-freelancer-id="<?php echo e($member->freelancer_id); ?>">
                                                                    <?php echo e($member->freelancer->full_name ?? 'Unknown'); ?>

                                                                </a>
                                                            </h5>
                                                            <p class="mb-0 fs-xxs">
                                                                <span class="fw-medium">Email:</span>
                                                                <span class="text-muted"><?php echo e($member->freelancer->email ?? 'N/A'); ?></span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex">
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <?php echo e($member->invited_at->format('M d, Y')); ?>

                                                            </h5>
                                                            <p class="mb-0 fs-xxs">
                                                                <span class="text-muted"><?php echo e($member->invited_at->format('h:i A')); ?></span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="text-truncate" style="max-width: 200px;" 
                                                         ...
                                                         title="<?php echo e($member->invitation_message); ?>">
                                                        <?php echo e(Str::limit($member->invitation_message, 50)); ?>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <span class="badge badge-soft-<?php echo e($statusColors[$member->status]); ?> p-1">
                                                                    <?php echo e(strtoupper($member->status)); ?>

                                                                </span>
                                                            </h5>
                                                            <p class="mb-0 fs-xxs">
                                                                <span class="text-muted"><?php echo e($statusTexts[$member->status]); ?></span>
                                                                <?php if($member->responded_at): ?>
                                                                    <br>
                                                                    <small>Responded: <?php echo e($member->responded_at->format('M d, Y')); ?></small>
                                                                <?php endif; ?>
                                                            </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <button type="button" class="btn btn-sm view-freelancer-btn" data-freelancer-id="<?php echo e($member->freelancer_id); ?>">
                                                            <i class="ti ti-eye fs-lg"></i>
                                                        </button>
                                                        
                                                        <?php if($member->status === 'pending'): ?>
                                                            <button type="button" class="btn btn-sm cancel-invitation-btn" data-invitation-id="<?php echo e($member->id); ?>"data-freelancer-name="<?php echo e($member->freelancer->full_name ?? 'Unknown'); ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.view-freelancer-btn', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route("owner.members.freelancer.details", ":id")); ?>'.replace(':id', freelancerId),
                    type: 'GET',
            ...
            $('#cancelInvitationForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route("owner.members.cancel", ":id")); ?>'.replace(':id', currentInvitationId),
                    type: 'POST',
                    data: $(this).serialize(),
                    headers: {
...
<?php echo $__env->make('layouts.owner.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/owner/view-members.blade.php ENDPATH**/ ?>
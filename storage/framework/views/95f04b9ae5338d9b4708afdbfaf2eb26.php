                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <?php if($member->freelancer && $member->freelancer->profile && $member->freelancer->profile->brand_logo): ?>
                                                            <img src="/storage/<?php echo e($member->freelancer->profile->brand_logo); ?>" 
                                                                 class="rounded-circle me-3" 
                                                                 style="width: 40px; height: 40px; object-fit: cover;" 
                                                                 alt="<?php echo e($member->freelancer->full_name); ?>">
                                                        <?php else: ?>
                                            ...
                                            <tr>
                                                <td colspan="5" class="text-center py-4">
                                                    <div class="text-muted">
                                                        ...
                                                        <a href="<?php echo e(route('owner.members.invite')); ?>" class="btn btn-primary mt-2">

    ...
    <script>
        $(document).ready(function() {
            ...
            function loadBookingDetails(bookingId) {
                $.ajax({
                    url: '<?php echo e(route("freelancer.booking.details", ":id")); ?>'.replace(':id', bookingId),
                    type: 'GET',
                    beforeSend: function() {
            ...
            function submitStatusUpdate(status, reason) {
                $.ajax({
                    url: '<?php echo e(route("freelancer.booking.update.status", ":id")); ?>'.replace(':id', currentBookingId),
                    type: 'PUT',
                    data: {
                        status: status,
                        reason: reason,
            ...
            function sendPaymentUpdate(paymentStatus, notes) {
                $.ajax({
                    url: '<?php echo e(route("freelancer.booking.update.payment.status", ":id")); ?>'.replace(':id', currentBookingId),
                    type: 'PUT',
                    data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.freelancer.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/freelancer/view-bookings.blade.php ENDPATH**/ ?>
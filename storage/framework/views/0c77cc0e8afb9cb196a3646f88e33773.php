...
<?php $__env->startSection('title', 'My Online Galleries'); ?>
            ...
            <div class="row">
                <?php $__empty_1 = true; $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-xl-4 col-md-6">
                        <div class="card gallery-card" data-gallery-id="<?php echo e($gallery->id); ?>" data-gallery-type="<?php echo e($gallery->type); ?>">
                            <div class="position-relative">
                                <?php if($gallery->thumbnail): ?>
                                    <img src="<?php echo e(asset('storage/' . $gallery->thumbnail)); ?>" 
                                        class="card-img-top gallery-thumbnail" 
                                        alt="<?php echo e($gallery->gallery_name); ?>"
                                ...
                                <span class="position-absolute top-0 end-0 badge bg-primary m-3">
                                    <i class="ti ti-photo me-1"></i><?php echo e($gallery->total_photos); ?> Photos
                                </span>
                                
                                <span class="position-absolute top-0 start-0 badge badge-soft-primary m-3">
                                    <?php echo e($gallery->type === 'studio' ? 'Studio' : 'Freelancer'); ?>

                                </span>
                            </div>
                            
                            <div class="card-body">
                                <h5 class="card-title text-truncate mb-2"><?php echo e($gallery->gallery_name); ?></h5>
                                
                                <div class="d-flex align-items-center mb-2">
                                    <i class="ti ti-building-store fs-5 text-primary me-2"></i>
                                    <span class="text-muted small"><?php echo e($gallery->provider_name); ?></span>
                                </div>
                                
                                <div class="d-flex align-items-center mb-2">
                                    <i class="ti ti-hash fs-5 text-primary me-2"></i>
                                    <span class="text-muted small"><?php echo e($gallery->booking_reference); ?></span>
                                </div>
                                
                                <div class="d-flex align-items-center mb-2">
                                    <i class="ti ti-calendar fs-5 text-primary me-2"></i>
                                    <span class="text-muted small"><?php echo e($gallery->event_date); ?></span>
                                </div>
                                
                                <?php if($gallery->description): ?>
                                    <p class="card-text text-muted small mt-2">
                                        <?php echo e(Str::limit($gallery->description, 80)); ?>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <span class="text-muted small">
                                        <i class="ti ti-clock me-1"></i><?php echo e($gallery->created_at); ?>

                                    </span>
                                    
                                    <button class="btn btn-primary btn-sm view-gallery-btn"
                                            data-gallery-id="<?php echo e($gallery->id); ?>"
                                            data-gallery-type="<?php echo e($gallery->type); ?>"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.view-gallery-btn').on('click', function() {
                ...
                $.ajax({
                    url: `<?php echo e(url('client/online-gallery')); ?>/${galleryId}/${galleryType}`,
                    type: 'GET',
            ...
            function updateFullscreenImage() {
                const imageUrl = `<?php echo e(asset('storage')); ?>/${currentImages[currentIndex]}`;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.client.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/client/view-online-gallery.blade.php ENDPATH**/ ?>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex">
                                                <div>
                                                    <h5 class="mb-1">
                                                        <a href="javascript:void(0)" class="link-reset view-user" data-id="<?php echo e($user->id); ?>">
                                                ...
                                                <div>
                                                    <h5 class="mb-1">
                                                        <a href="javascript:void(0)" class="link-reset">
                                                            <?php echo e($user->formatted_role); ?>

                                                        </a>
                                                    </h5>
                                                    <p class="mb-0 fs-xxs">
                                                        <span class="text-muted"><?php echo e($user->formatted_user_type); ?></span>
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex">
                                                <div>
                                                    <h5 class="mb-1">
                                                        <span class="text-dark"><?php echo e($user->location ? $user->location->municipality : '—'); ?></span>
                                                    </h5>
                                                    <p class="mb-0 fs-xxs">
                                                        <span class="fw-medium">Province:</span>
                                                        <span class="text-muted"><?php echo e($user->location ? $user->location->province : '—'); ?></span>
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="badge badge-soft-<?php echo e($user->formatted_status['class']); ?> fs-8 px-1 w-100">
                                                <?php echo e($user->formatted_status['label']); ?>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-1">
                                                <a href="javascript:void(0)" class="btn btn-sm view-user" data-id="<?php echo e($user->id); ?>" data-bs-toggle="modal" data-bs-target="#userModal">
                                                    <i class="ti ti-eye fs-lg"></i>
                                                </a>
                                                <a href="javascript:void(0)" class="btn btn-sm edit-user" data-id="<?php echo e($user->id); ?>">
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-center flex-column flex-md-row gap-4 gap-md-5">
                                <div class="flex-shrink-0 position-relative">
                                    <img src="<?php echo e(asset('assets/uploads/profile_placeholder.jpg')); ?>" alt="avatar" class="rounded-circle border border-4 border-white shadow" id="modalProfilePhoto" style="width: 110px; height: 110px; object-fit: cover;">
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.view-user', function() {
                ...
                const url = "<?php echo e(route('admin.user.details', ':id')); ?>".replace(':id', userId);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/admin/view-users.blade.php ENDPATH**/ ?>
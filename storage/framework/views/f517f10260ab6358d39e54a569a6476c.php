                        ...
                        <?php if(auth()->guard()->check()): ?>
                            ...
                            <?php if(auth()->user()->profile_photo): ?>
                                <?php
                                    ...
                                    $profilePath = 'profile-photos/'; // Default for studio photographers
                                    if(auth()->user()->role === 'studio-photographer') {
                                        $profilePath = 'profile-photos/';
                                    } elseif(auth()->user()->role === 'owner') {
                                        $profilePath = 'profiles/owners/'; // or whatever path you use for owners
                                    } elseif(auth()->user()->role === 'admin') {
                                        $profilePath = 'profiles/admins/'; // or whatever path you use for admins
                                    }
                                    // Add other roles as needed
                                ?>
                                <img src="<?php echo e(asset('storage/' . $profilePath . auth()->user()->profile_photo)); ?>" width="32" height="32" class="rounded-circle me-lg-2 d-flex" alt="user-image">
                            <?php else: ?>
                                <!-- Default image -->
                                <img src="<?php echo e(asset('assets/images/users/user-3.jpg')); ?>" width="32" height="32" class="rounded-circle me-lg-2 d-flex" alt="user-image">
                            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\proj\resources\views/layouts/studio-photographer/topbar.blade.php ENDPATH**/ ?>
                ...
                <div class="dropdown">
                    <a class="topbar-link dropdown-toggle drop-arrow-none px-2" data-bs-toggle="dropdown"
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            ...
                            <?php else: ?>
                                <img src="<?php echo e(asset('/assets/uploads/profile_placeholder.jpg')); ?>" width="32"
                                    class="rounded-circle me-lg-2 d-flex" alt="user-image">
                            <?php endif; ?>
                            <div class="d-lg-flex align-items-center gap-1 d-none">
                                <h5 class="my-0"><?php echo e(auth()->user()->full_name ?? auth()->user()->first_name . ' ' . auth()->user()->last_name); ?></h5>
...
</header><?php /**PATH C:\xampp\htdocs\proj\resources\views/layouts/freelancer/topbar.blade.php ENDPATH**/ ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-custom table-centered table-select table-hover table-bordered w-100 mb-0">
                                ...
                                <tbody id="packagesTableBody">
                                    ...
                                    <tr class="package-row" data-status="<?php echo e($package->status); ?>">
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-1">
                                                <button class="btn btn-sm btn-edit" data-id="<?php echo e($package->id); ?>">
                                                    <i class="ti ti-edit fs-lg"></i>
                                                </button>
                                                <button class="btn btn-sm btn-delete" data-id="<?php echo e($package->id); ?>">
                                    ...
                                    <tr>
                                        <td colspan="7" class="text-center py-4">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <a href="<?php echo e(route('freelancer.packages.create')); ?>" class="btn btn-primary btn-sm mt-2">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.freelancer.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/freelancer/view-packages.blade.php ENDPATH**/ ?>
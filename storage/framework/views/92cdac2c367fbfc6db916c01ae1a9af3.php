                                        ...
                                        <div class="card shadow-none border h-100 my-4 my-lg-0">
                                            <div class="card-body p-lg-4 pb-0 text-center">
                                                ...
                                                <div class="my-4">
                                                    ...
                                                    <div class="d-flex justify-content-center mt-2">
                                                        <span class="badge <?php echo e($package->online_gallery ? 'badge-soft-success' : 'badge-soft-secondary'); ?> px-2 py-1">
                                                            <i class="ti ti-photo <?php echo e($package->online_gallery ? '' : 'ti-photo-off'); ?> me-1"></i>
                                                            Online Gallery: <?php echo e($package->online_gallery ? 'Yes' : 'No'); ?>
                                            ...
                                            <div class="card-footer bg-transparent px-5 pb-4">
                                                <div class="d-flex gap-2">
                                                    <button class="btn btn-outline-primary w-100 py-2 fw-semibold rounded-pill view-details-btn" data-package-id="<?php echo e($package->id); ?>"data-category-id="<?php echo e($package->category_id); ?>">
                                                        View Details
                                                    </button>
                                                </div>
                                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadPackageDetails(packageId) {
                ...
                $.ajax({
                    url: '<?php echo e(url("freelancer/packages")); ?>/' + packageId,
                    type: 'GET',
                    dataType: 'json',

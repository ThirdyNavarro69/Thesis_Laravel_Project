    ...
    <script>
        $(document).ready(function() {
            ...
            $('#registerForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route("auth.register.store")); ?>',
                    method: 'POST',
                    data: $(this).serialize(),
                    dataType: 'json',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.auth.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/auth/register.blade.php ENDPATH**/ ?>
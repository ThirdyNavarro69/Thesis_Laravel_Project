    ...
    <script>
        $(document).ready(function() {
            ...
            $('#createServiceForm').on('submit', function(e) {
                ...
                // AJAX request
                $.ajax({
                    url: "<?php echo e(route('freelancer.services.store')); ?>",
                    type: 'POST',
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            Swal.fire({
                                ...
                                window.location.href = "<?php echo e(route('freelancer.services.index')); ?>";
                            });
                        } else {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.freelancer.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/freelancer/create-services.blade.php ENDPATH**/ ?>
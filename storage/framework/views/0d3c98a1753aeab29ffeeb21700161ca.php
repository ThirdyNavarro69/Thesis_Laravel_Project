...
<body>
    <div class="email-container">
        <div class="header">
            <img src="<?php echo e(asset('assets/images/logo-black.png')); ?>" alt="PHOTOGRAPHY Platform Logo" class="logo">
        ...
        <div class="content">
            <p>Hello <strong><?php echo e($user->full_name); ?></strong>,</p>
            ...
            <div class="user-info">
                <div class="info-item">
                    ...
                    <span><?php echo e($user->first_name); ?> <?php echo e($user->middle_name ? $user->middle_name . ' ' : ''); ?><?php echo e($user->last_name); ?></span>
                </div>
                <div class="info-item">
                    <span class="info-label">Account Type:</span> 
                    <span style="text-transform: capitalize;"><?php echo e($user->role); ?></span>
                </div>
                <div class="info-item">
                    <span class="info-label">Registered Email:</span> <?php echo e($user->email); ?>

                </div>
                <div class="info-item">
                    <span class="info-label">Registration Date:</span> <?php echo e($user->created_at->format('F d, Y h:i A')); ?>
            ...
            <a href="<?php echo e($verificationUrl); ?>" class="verification-button">Verify Email Address</a>
            ...
            <div class="alternative-link">
                <a href="<?php echo e($verificationUrl); ?>"><?php echo e($verificationUrl); ?></a>
            </div>
        ...
        <div class="footer">
            <p>© <?php echo e(date('Y')); ?> PHOTOGRAPHY Platform. All rights reserved.</p>
...
</html><?php /**PATH C:\xampp\htdocs\proj\resources\views/emails/verification.blade.php ENDPATH**/ ?>
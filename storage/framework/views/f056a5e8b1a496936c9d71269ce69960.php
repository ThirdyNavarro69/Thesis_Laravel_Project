<?php $__env->startSection('title', 'Client Bookings'); ?>
                                        ...
                                        <tr data-booking-id="<?php echo e($booking->id); ?>">
                                            <td>
                                                <div class="d-flex">
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <div class="link-reset"><?php echo e($booking->client->first_name); ?> <?php echo e($booking->client->last_name); ?></div>
                                                        </h5>
                                                        <p class="mb-0 fs-xxs">
                                                            <span class="fw-medium">Booking ID:</span>
                                                            <span class="text-muted"><?php echo e($booking->booking_reference); ?></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <div>
                                                        <p class="mb-1"><?php echo e(\Carbon\Carbon::parse($booking->event_date)->format('F d, Y')); ?></p>
                                                        <p class="mb-0 fs-xxs">
                                                            <span class="text-muted"><?php echo e($booking->start_time); ?></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                ...
                                                ?>
                                                <span class="badge <?php echo e($statusBadge); ?> fs-8 px-1 w-100 text-uppercase"><?php echo e(str_replace('_', ' ', $booking->status)); ?></span>
                                            </td>
                                            <td>
                                                <?php
                                                    $paymentBadge = [
                                                ...
                                                ?>
                                                <span class="badge <?php echo e($paymentBadge); ?> fs-8 px-1 w-100 text-uppercase"><?php echo e(str_replace('_', ' ', $booking->payment_status)); ?></span>
                                            </td>
                                            <td>PHP <?php echo e(number_format($booking->remaining_balance, 2)); ?></td>
                                            <td>PHP <?php echo e(number_format($booking->total_amount, 2)); ?></td>
                                            <td>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.update-status-btn', function() {
                ...
                if (currentBookingData) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route("owner.booking.details", ":id")); ?>'.replace(':id', bookingId),
                        type: 'GET',
            ...
            $('#confirmStatusUpdate').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '<?php echo e(route("owner.booking.update.status", ":id")); ?>'.replace(':id', currentBookingId),
                            type: 'PUT',
                            data: {
                                status: status,
            ...
            $(document).on('click', '.complete-booking-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '<?php echo e(route("owner.booking.complete", ":id")); ?>'.replace(':id', bookingId),
                            type: 'PUT',
                            data: {
                                _token: '<?php echo e(csrf_token()); ?>'
                            },
            ...
            function loadAvailablePhotographers(bookingId) {
                $.ajax({
                    url: '<?php echo e(route("owner.booking.available.photographers", ":id")); ?>'.replace(':id', bookingId),
                    type: 'GET',
                    beforeSend: function() {
            ...
            function assignPhotographers(photographerIds, notes) {
                $.ajax({
                    url: '<?php echo e(route("owner.booking.assign.photographers", ":id")); ?>'.replace(':id', currentBookingId),
                    type: 'POST',
                    data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.owner.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/owner/view-bookings.blade.php ENDPATH**/ ?>
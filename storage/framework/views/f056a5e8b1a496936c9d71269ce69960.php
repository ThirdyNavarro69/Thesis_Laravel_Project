            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-4">
                                            ...
                                            <div class="col-12">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <p class="mb-0 fw-medium text-warning">Pending</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row gap-2">
                            <button class="col btn btn-soft-danger btn-sm">
                                <i data-lucide="x-circle" class="me-1 fs-14"></i> Reject Booking
                            </button>
                            <button class="col btn btn-primary btn-sm">
                                <i data-lucide="check-circle" class="me-1 fs-14"></i> Approve Booking
                            </button>
                        </div>
                    </div>
                </div>

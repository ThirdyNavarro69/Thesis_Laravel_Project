...
<body>
    ...
    <div class="wrapper">
        <?php echo $__env->make('layouts.studio-photographer.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('layouts.studio-photographer.topbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->yieldContent('content'); ?>
        <?php echo $__env->make('layouts.studio-photographer.theme', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\proj\resources\views/layouts/studio-photographer/app.blade.php ENDPATH**/ ?>
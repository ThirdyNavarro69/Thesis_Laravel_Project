<div class="sidenav-menu">
    ...
    <div class="scrollbar" data-simplebar>
        <ul class="side-nav">
            ...
            <li class="side-nav-item <?php echo e($manageBookingsRoutes || $bookingHistoryRoutes ? 'active' : ''); ?>">
                <a data-bs-toggle="collapse" href="#sidebarManageBookings" aria-expanded="<?php echo e($manageBookingsRoutes || $bookingHistoryRoutes ? 'true' : 'false'); ?>" aria-controls="sidebarManageBookings" class="side-nav-link <?php echo e($manageBookingsRoutes || $bookingHistoryRoutes ? 'active' : ''); ?>">
                    <span class="menu-icon"><i data-lucide="notebook-pen"></i></span>
                    <span class="menu-text" data-lang="manage-bookings">Bookings</span>
                    <span class="menu-arrow"></span>
                </a>
                <div class="collapse <?php echo e($manageBookingsRoutes || $bookingHistoryRoutes ? 'show' : ''); ?>" id="sidebarManageBookings">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a href="<?php echo e(route('freelancer.booking.index')); ?>" class="side-nav-link <?php echo e($manageBookingsRoutes ? 'active' : ''); ?>">
                                <span class="menu-text" data-lang="view-bookings">View Bookings</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="<?php echo e(route('freelancer.booking.history')); ?>" class="side-nav-link <?php echo e($bookingHistoryRoutes ? 'active' : ''); ?>">
            ...
            <li class="side-nav-item <?php echo e($manageOnlineGalleryRoutes ? 'active' : ''); ?>">
                <a href="<?php echo e(route('freelancer.online-gallery.index')); ?>" class="side-nav-link <?php echo e($manageOnlineGalleryRoutes ? 'active' : ''); ?>">

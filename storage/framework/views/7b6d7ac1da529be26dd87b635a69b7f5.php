...
<?php $__env->startSection('title', 'Create Packages'); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <div class="btn-group w-100 mb-1" role="group" aria-label="Online Gallery Toggle">
                                            <input type="radio" class="btn-check" name="online_gallery" id="galleryYes" value="1">
                                            <label class="btn btn-outline-primary" for="galleryYes">
                                                <i class="ti ti-check me-1"></i> Yes, include online gallery
                                            </label>

                                            <input type="radio" class="btn-check" name="online_gallery" id="galleryNo" value="0" checked>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#createPackageForm').on('submit', function(e) {
                ...
                // Send AJAX request
                $.ajax({
                    url: "<?php echo e(route('freelancer.packages.store')); ?>",
                    type: "POST",
                    data: formData,
                    headers: {
                    ...
                    success: function(response) {
                        if (response.success) {
                            Swal.fire({
                                ...
                                window.location.href = "<?php echo e(route('freelancer.packages.index')); ?>";
                            });
                        } else {
                            Swal.fire({
                                icon: 'error',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.freelancer.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/freelancer/create-packages.blade.php ENDPATH**/ ?>
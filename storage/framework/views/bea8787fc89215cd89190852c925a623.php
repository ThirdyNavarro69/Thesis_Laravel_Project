    ...
    <script>
        $(document).ready(function() {
            ...
            $('#createPackageForm').submit(function(e) {
                ...
                // Submit via AJAX
                $.ajax({
                    url: "<?php echo e(route('owner.packages.store')); ?>",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(response) {
                        if (response.success) {
                            ...
                            setTimeout(() => {
                                ...
                                window.location.href = "<?php echo e(route('owner.packages.index')); ?>";
                            }, 1500);
                        }
                    },
                    error: function(xhr) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.owner.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/owner/create-packages.blade.php ENDPATH**/ ?>
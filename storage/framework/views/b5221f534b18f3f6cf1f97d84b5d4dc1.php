...
<?php $__env->startSection('title', 'View Locations'); ?>
                            ...
                            <table class="table table-custom table-centered table-select table-hover table-bordered w-100 mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr data-id="<?php echo e($location->id); ?>">
                                            <td><?php echo e(ucfirst($location->province)); ?></td>
                                            <td><?php echo e($location->municipality); ?></td>
                                            <td>
                                                <?php if(is_array($location->barangay) && count($location->barangay) > 0): ?>
                                                    <?php echo e($location->barangay[0]); ?>

                                                    <?php if(count($location->barangay) > 1): ?>
                                                        <span class="text-muted">+<?php echo e(count($location->barangay) - 1); ?> more</span>
                                                    <?php endif; ?>
                                                <?php else: ?>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <button type="button" class="btn btn-sm view-barangay-btn" 
                                                            ...
                                                            data-municipality="<?php echo e($location->municipality); ?>"
                                                            data-zipcode="<?php echo e($location->zip_code); ?>"
                                                            data-status="<?php echo e($location->status); ?>"
                                                            data-barangays="<?php echo e(htmlspecialchars(json_encode($location->barangay), ENT_QUOTES, 'UTF-8')); ?>">
                                                        <i class="ti ti-eye fs-lg"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-sm delete-location-btn" data-id="<?php echo e($location->id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/admin/view-locations.blade.php ENDPATH**/ ?>
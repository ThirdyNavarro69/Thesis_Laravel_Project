...
<?php $__env->startSection('title', 'Pending Studios'); ?>
...
<?php $__env->startSection('content'); ?>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <div class="avatar-lg me-1">
                                                    ...
                                                    <?php else: ?>
                                                        <img src="<?php echo e(asset('assets/images/products/1.png')); ?>" alt="Studio Logo" class="img-fluid rounded">
                                                    <?php endif; ?>
                                                </div>
                                                <div>
                                                    <h5 class="mb-1">
    ...
    <?php $__currentLoopData = $studios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="modal-body p-4">
                            ...
                            <div class="col-12 col-lg-8">
                                <div class="d-flex align-items-center flex-column flex-md-row">
                                    <div class="flex-shrink-0 mb-3 mb-md-0">
                                        ...
                                        <?php else: ?>
                                            <img src="<?php echo e(asset('assets/images/sellers/7.png')); ?>" class="rounded-circle" style="width: 80px; height: 80px; object-fit: cover;" alt="Studio Logo">
                                        <?php endif; ?>
                                    </div>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <?php if($studio->contact_number || $studio->studio_email || $studio->facebook_url || $studio->instagram_url || $studio->website_url): ?>
                                <div class="row g-2 mb-3">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="mb-0 fw-medium text-truncate"><?php echo e($studio->user->uuid); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                                    <?php if($studio->user->email_verified): ?>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="mb-0 fw-medium"><?php echo e(ucfirst($studio->user->role)); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="mb-0 fw-medium">
                                                    <a href="<?php echo e(asset('storage/' . $studio->business_permit)); ?>" target="_blank" class="text-primary text-decoration-none">
                                ...
                                <div class="row mt-4">
                                    <div class="col text-end">
                                        <button type="button" class="btn btn-soft-danger me-2" data-bs-toggle="modal" data-bs-target="#rejectModal<?php echo e($studio->id); ?>">
                                            Reject Studio
                                        </button>
                                        <button type="button" class="btn btn-primary approve-studio" data-id="<?php echo e($studio->id); ?>">
                                            Approve Studio
                                        </button>
                                    </div>
                                </div>
        ...
        <div class="modal fade" id="rejectModal<?php echo e($studio->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form id="rejectForm<?php echo e($studio->id); ?>" class="reject-form">
                        <?php echo csrf_field(); ?>
                        <div class="modal-body">
                            <p class="mb-3">You are about to reject <strong><?php echo e($studio->studio_name); ?></strong>. Please provide a reason for rejection.</p>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-danger reject-studio" data-id="<?php echo e($studio->id); ?>">Confirm Rejection</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.approve-studio', function(e) {
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        ...
                        return $.ajax({
                            url: "<?php echo e(route('admin.studio.approve', ':id')); ?>".replace(':id', studioId),
                            type: 'POST',
                            headers: {
            ...
            $(document).on('submit', '.reject-form', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo e(route('admin.studio.reject', ':id')); ?>".replace(':id', studioId),
                            type: 'POST',
                            data: formData,
                            headers: {
                                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            ...
            //         if (result.isConfirmed) {
            //             $.ajax({
            //                 url: "<?php echo e(route('admin.studio.destroy', ':id')); ?>".replace(':id', studioId),
            //                 type: 'DELETE',
            //                 headers: {
            //                     'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            //                 },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/admin/pending-studios.blade.php ENDPATH**/ ?>
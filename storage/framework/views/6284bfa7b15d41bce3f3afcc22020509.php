<?php $__env->startSection('title', 'View Assigned Bookings'); ?>
                                        ...
                                        <tr data-assignment-id="<?php echo e($assignment->id); ?>">
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <span class="fw-medium"><?php echo e($assignment->booking->booking_reference ?? 'N/A'); ?></span>
                                                </div>
                                            </td>
                                            <td>
                                                <?php if($assignment->booking && $assignment->booking->client): ?>
                                                    <?php echo e($assignment->booking->client->first_name); ?> <?php echo e($assignment->booking->client->last_name); ?>
                                            ...
                                            <td>
                                                <?php echo e($assignment->studio->studio_name ?? 'N/A'); ?>

                                            </td>
                                            <td>
                                                <?php echo e($assignment->booking->event_name ?? 'N/A'); ?>

                                            </td>
                                            <td>
                                                <div class="d-flex">
                                                    <div>
                                                        <p class="mb-1"><?php echo e($assignment->booking ? \Carbon\Carbon::parse($assignment->booking->event_date)->format('M d, Y') : 'N/A'); ?></p>
                                                        <p class="mb-0 fs-xxs text-muted">
                                                            <?php echo e($assignment->booking ? $assignment->booking->start_time : 'N/A'); ?>
                                            ...
                                            <td>
                                                <span class="fw-semibold">
                                                    PHP <?php echo e($assignment->booking ? number_format($assignment->booking->total_amount, 2) : '0.00'); ?>

                                                </span>
                                            </td>
                                            <td>
                                                <?php if($assignment->assigner): ?>
                                                    <?php echo e($assignment->assigner->first_name); ?> <?php echo e($assignment->assigner->last_name); ?>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <span class="badge <?php echo e($statusBadge); ?> fs-8 px-1 w-100 text-uppercase">
                                                    <?php echo e($assignment->status); ?>

                                                </span>
                                            </td>
                                            <td>
                                                <?php echo e(\Carbon\Carbon::parse($assignment->assigned_at)->format('M d, Y')); ?>

                                            </td>
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <button class="btn btn-sm view-assignment-btn" data-assignment-id="<?php echo e($assignment->id); ?>" data-bs-toggle="modal" data-bs-target="#assignmentModal">
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadAssignmentDetails(assignmentId) {
                $.ajax({
                    url: '<?php echo e(route("assignment.details", ":id")); ?>'.replace(':id', assignmentId),
                    type: 'GET',
                    beforeSend: function() {
            ...
            function showStatusUpdateModal(status) {
                ...
                $.ajax({
                    url: '<?php echo e(route("assignment.details", ":id")); ?>'.replace(':id', currentAssignmentId),
                    type: 'GET',
                    success: function(response) {
                        if (response.success) {
            ...
            function updateAssignmentStatus(status, reason = null) {
                $.ajax({
                    url: '<?php echo e(route("assignment.update-status", ":id")); ?>'.replace(':id', currentAssignmentId),
                    type: 'POST',
                    data: {
                        status: status,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.studio-photographer.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/studio-photographer/view-assigned-booking.blade.php ENDPATH**/ ?>
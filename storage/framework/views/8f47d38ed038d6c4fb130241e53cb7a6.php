...
<?php $__env->startSection('title', 'Create Locations'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            form.on('submit', function(e) {
                ...
                // AJAX request
                $.ajax({
                    url: "<?php echo e(route('admin.location.store')); ?>",
                    type: "POST",
                    data: formData,
                    success: function(response) {
                        if (response.success) {
                            ...
                            Swal.fire({
                                ...
                                window.location.href = "<?php echo e(route('admin.location.index')); ?>";
                            });
                        } else {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/admin/create-locations.blade.php ENDPATH**/ ?>
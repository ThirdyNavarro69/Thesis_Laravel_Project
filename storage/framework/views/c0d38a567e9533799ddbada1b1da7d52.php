...
<?php $__env->startSection('title', 'Clients Online Gallery'); ?>
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($booking->client->first_name ?? ''); ?>

                                                <?php echo e($booking->client->last_name ?? ''); ?></td>
                                            <td><?php echo e($booking->formatted_event_date ?? 'N/A'); ?></td>
                                            <td><?php echo e($booking->category->category_name ?? 'N/A'); ?></td>
                                            <td>
                                                <?php if($booking->packages->isNotEmpty()): ?>
                                                    <?php
                                                        $package = $booking->packages->first();
                                                        $packageName = $package->studioPackage->package_name ?? 'N/A';
                                                    ?>
                                            ...
                                            <td class="text-center">
                                                <?php if($booking->has_gallery): ?>
                                                    <button class="btn btn-sm manage-gallery"
                                                        data-booking-id="<?php echo e($booking->id); ?>" title="Manage Gallery">
                                                        <i class="ti ti-library-photo fs-5" aria-hidden="true"></i>
                                                    </button>
                                                <?php else: ?>
                                                    <button class="btn btn-sm create-gallery"
                                                        data-booking-id="<?php echo e($booking->id); ?>" title="Create Gallery">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.create-gallery, .manage-gallery', function() {
                ...
                $.ajax({
                    url: `<?php echo e(url('studio-photographer/online-gallery')); ?>/${bookingId}/details`,
                    type: 'GET',
                    ...
                    error: function(xhr) {
                        let message = 'Failed to load gallery details';
                        ...
                        <div class="col-md-3 col-sm-4 col-6 mb-3">
                            <div class="card">
                                <div class="position-relative">
                                    <img src="<?php echo e(asset('storage')); ?>/${image}" class="card-img-top" alt="Gallery Image" style="height: 150px; object-fit: cover;">
            ...
            $('#uploadGalleryForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: `<?php echo e(url('studio-photographer/online-gallery')); ?>/${selectedBookingId}/upload`,
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $(document).on('click', '.delete-image', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `<?php echo e(url('studio-photographer/online-gallery')); ?>/${currentGalleryId}/image`,
                            type: 'DELETE',
                            data: {
            ...
            $('#deleteGalleryBtn').on('click', function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `<?php echo e(url('studio-photographer/online-gallery')); ?>/${currentGalleryId}`,
                            type: 'DELETE',
                            data: {
                                _token: '<?php echo e(csrf_token()); ?>'
                            },
                            ...
                            error: function(xhr) {
                                let message = 'Failed to delete gallery';
                                if (xhr.responseJSON && xhr.responseJSON.message) {
                                    message = xhr.responseJSON.message;
                                }
            ...
            $('#updateGalleryForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: `<?php echo e(url('studio-photographer/online-gallery')); ?>/${galleryId}`,
                    type: 'PUT',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                    ...
                    error: function(xhr) {
                        let message = 'Failed to update gallery';
                        if (xhr.responseJSON && xhr.responseJSON.message) {
                            message = xhr.responseJSON.message;
                        }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.studio-photographer.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/studio-photographer/view-online-gallery.blade.php ENDPATH**/ ?>
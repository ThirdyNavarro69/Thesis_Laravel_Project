            ...
            <div class="col-xxl-4 col-md-6 col-sm-8">
                <div class="card p-4">
                    ...
                    <p class="text-muted text-center mt-4 mb-0">
                        Don't have account? <a href="<?php echo e(route('register')); ?>" class="text-primary">Create an account</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#loginForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route("auth.login.store")); ?>',
                    method: 'POST',
                    data: $(this).serialize(),
                    dataType: 'json',
                            ...
                            if (response.needs_verification) {
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        window.location.href = '<?php echo e(route("verify")); ?>';
                                    }
                                });
                            } else {
                                Swal.fire({
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.auth.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/auth/login.blade.php ENDPATH**/ ?>
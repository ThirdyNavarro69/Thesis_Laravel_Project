                    ...
                    <div class="card">
                        <div class="card-header card-title">
                            ...
                            <p class="text-muted mb-0">Booking for
                                <?php echo e($type === 'studio' ? $provider->studio_name : $provider->brand_name); ?></p>
                        </div>
                        <div class="card-body">
                            <form id="bookingForm" class="needs-validation" novalidate>
                                <?php echo csrf_field(); ?>
                                <input type="hidden" id="bookingType" value="<?php echo e($type); ?>">
                                <input type="hidden" id="providerId" value="<?php echo e($id); ?>">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="tel" class="form-control" id="contactNumber"
                                                value="<?php echo e($user->mobile_number); ?>" placeholder="Enter your contact number"
                                                required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="email" class="form-control" id="email"
                                                value="<?php echo e($user->email); ?>" placeholder="Enter your email address" required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="date" class="form-control" id="eventDate" name="event_date"
                                                    ...
                                                    max="<?php echo e(date('Y-m-d', strtotime('+60 days'))); ?>"
    ...
    <script>
        $(document).ready(function() {
            ...
            function debugFreelancerPackages() {
                ...
                if (type === 'freelancer') {
                    $.ajax({
                        url: '<?php echo e(route("client.bookings.packages")); ?>',
                        type: 'POST',
                        data: {
                            type: type,
            ...
            $('#checkDateBtn').on('click', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route("client.bookings.check-availability")); ?>',
                    type: 'POST',
                    data: {
                        type: type,
                        provider_id: providerId,
            ...
            $(document).on('change', '#city', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route("client.locations.barangays")); ?>',
                    type: 'POST',
                    data: {
            ...
            function getBookingSummaryWithPaymentType(packageData, paymentType) {
                ...
                $.ajax({
                    url: '<?php echo e(route("client.bookings.summary")); ?>',
                    type: 'POST',
                    data: {
            ...
            function processBooking() {
                ...
                // Create booking
                $.ajax({
                    url: '<?php echo e(route("client.bookings.store")); ?>',
                    type: 'POST',
                    data: bookingData,
                    success: function(response) {
                        if (response.success) {
            ...
            function getCalendarAvailability(year, month) {
                ...
                return $.ajax({
                    url: '<?php echo e(route("client.bookings.calendar-availability")); ?>',
                    type: 'POST',
                    data: {
                        type: type,
                        provider_id: providerId,

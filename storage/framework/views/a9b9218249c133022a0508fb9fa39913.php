...
<?php $__env->startSection('title', 'Registered Studio Photographers'); ?>
                                ...
                                <div class="app-filter">
                                    <select data-table-filter="studio" class="me-2 form-select form-control">
                                        ...
                                        <?php $__currentLoopData = $studios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($studio->id); ?>"><?php echo e($studio->studio_name); ?></option>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex">
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a href="javascript:void(0)" class="link-reset view-photographer" data-id="<?php echo e($photographer->id); ?>">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a href="javascript:void(0)" class="link-reset">
                                                                <?php echo e($photographer->position); ?>
                                            ...
                                            <td>
                                                <span class="badge badge-soft-<?php echo e($photographer->status === 'active' ? 'success' : 'danger'); ?> w-100">
                                                    <?php echo e(strtoupper($photographer->status)); ?>

                                                </span>
                                            </td>
                                            <td><?php echo e($photographer->created_at->format('F d, Y')); ?></td>
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <button type="button" class="btn btn-sm view-photographer-btn" data-id="<?php echo e($photographer->id); ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.view-photographer-btn, .view-photographer', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('owner.studio-photographers.show', ['id' => '__ID__'])); ?>".replace('__ID__', photographerId),
                    method: 'GET',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.owner.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/owner/view-studio-photographers.blade.php ENDPATH**/ ?>
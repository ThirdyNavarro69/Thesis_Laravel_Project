            ...
            <div class="row mt-3">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="profileSetupForm" method="POST" action="<?php echo e(route('freelancer.profile.store')); ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <h4 class="card-title text-primary mb-3">Personal Information</h4>
                                    <div class="col-md-12 mb-3">
                                        <label class="form-label">Freelancer Name</label>
                                        <input type="text" class="form-control" name="freelancer_name" value="<?php echo e(auth()->user()->first_name . ' ' . auth()->user()->last_name); ?>" readonly required>
                                    </div>

                                    <div class="col-md-12 mb-3">
                                        <label class="form-label">Email Address</label>
                                        <input type="email" class="form-control" name="freelancer_email" value="<?php echo e(auth()->user()->email); ?>" readonly required>
                                    </div>

                                    <div class="col-md-12 mb-3">
                                        <label class="form-label">Mobile Number</label>
                                        <input type="tel" class="form-control" name="freelancer_mobile_number" value="<?php echo e(auth()->user()->mobile_number); ?>" required>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#municipalitySelect').change(function() {
                ...
                $.ajax({
                    url: '<?php echo e(route("freelancer.profile.get-barangays")); ?>',
                    type: 'POST',
                    data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.freelancer.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/freelancer/setup-profile.blade.php ENDPATH**/ ?>
                    ...
                    <div data-table data-table-rows-per-page="5" class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table table-custom table-centered table-select table-hover table-bordered w-100 mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $assignedStudios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <?php
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex">
                                                    <div class="avatar-lg me-1">
                                                        <img src="<?php echo e($studio->studio_logo ? asset('storage/' . $studio->studio_logo) : asset('assets/uploads/profile_placeholder.jpg')); ?>" 
                                                            alt="<?php echo e($studio->studio_name); ?>" 
                                                            class="img-fluid rounded">
                                                    </div>
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a href="#" class="link-reset studio-name" data-studio-id="<?php echo e($studio->id); ?>">
                                                        ...
                                                        <p class="mb-0 fs-xxs">
                                                            ...
                                                            <span class="text-muted"><?php echo e($owner->first_name); ?> <?php echo e($owner->last_name); ?></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td><?php echo e($assignment->position ?? 'N/A'); ?></td>
                                            <td><?php echo e($assignment->specialization_display ?? 'N/A'); ?></td>
                                            <td>
                                                <span class="badge <?php echo e($statusClass); ?> fs-8 px-1 w-100"><?php echo e($statusText); ?></span>
                                            </td>
                                            <td><?php echo e($assignment->created_at->format('F d, Y')); ?></td>
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <a href="#" class="btn btn-sm view-studio-btn" 
                                                    data-bs-toggle="modal" 
                                                    data-bs-target="#studioModal"
                                                    data-studio-id="<?php echo e($studio->id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.studio-photographer.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proj\resources\views/studio-photographer/view-assigned-studio.blade.php ENDPATH**/ ?>
                    ...
                    <a class="topbar-link dropdown-toggle drop-arrow-none px-2" data-bs-toggle="dropdown"
                        ...
                        @auth
                            ...
                            @if(auth()->user()->profile_photo)
                                ...
                                @endphp
                                <img src="{{ asset('storage/' . $profilePath . auth()->user()->profile_photo) }}" width="32" height="32" class="rounded-circle me-lg-2 d-flex" alt="user-image">
                            @else
                                <!-- Default image -->
                                <img src="{{ asset('assets/images/users/user-3.jpg') }}" width="32" height="32" class="rounded-circle me-lg-2 d-flex" alt="user-image">
                            @endif
                            <div class="d-lg-flex align-items-center gap-1 d-none">
                                <h5 class="my-0">{{ auth()->user()->full_name ?? 'User' }}</h5>
